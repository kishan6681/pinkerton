-- <Migration ID="a7e40032-c778-4a39-87e2-10a163386933" />
GO
...
GO
ALTER TABLE [EA].[T_USR] ENABLE CHANGE_TRACKING
GO
...
GO
PRINT N'Creating [EA].[T_USR_VERSION_JSON]'
GO
...
GO
PRINT N'Creating primary key [PK_USR_VERSION_JSON] on [EA].[T_USR_VERSION_JSON]'
GO
...
GO
PRINT N'Creating primary key [PK__sysdiagr__C2B05B61F0D1F5BF] on [dbo].[sysdiagrams]'
GO
...
GO
PRINT N'Adding foreign keys to [EA].[T_USR_VERSION_JSON]'
GO
